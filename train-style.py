...
trainset_root = '../AFI/datasets/train_10k_540p'
train_flow_root = '../AFI/datasets/train_10k_pre_calc_sgm_flows'
train_size = (960, 540)
...
ret = model.load_state_dict(torch.load("checkpoints/anime_interp_full.ckpt")["model_state_dict"], strict=True)
print(ret)
